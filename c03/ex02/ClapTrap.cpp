...
void ClapTrap::setHP(unsigned int v)         { hit_pts = v; }
void ClapTrap::setEP(unsigned int v)         { energy_pts = v; }
void ClapTrap::setAD(unsigned int v)         { attack_dmg = v; }

const std::string& ClapTrap::getName() const { return name; }
unsigned int ClapTrap::getHP() const         { return hit_pts; }
unsigned int ClapTrap::getEP() const         { return energy_pts; }
unsigned int ClapTrap::getAD() const         { return attack_dmg; }